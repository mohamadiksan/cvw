...
// configure
$from = 'arya.10118148@yaxxx.xyz'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'mohamadiksan21@gmail.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    if($responseData->success):
        ...
        $errorMessage = 'Verifikasi Robot Hanya Bisa Dilakukan Satu Kali, Silahkan Muat Ulang Halaman Ini.';
        $responseArray = array('type' => 'danger', 'message' => $errorMessage);
        $encoded = json_encode($responseArray);
